...
<html lang="en">
<%-- ${pageContext.request.contextPath}/resources/alertify/themes/alertify.core.css --%>
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <div class="mobile-nav">
            ...
            <div class="amado-navbar-brand">
                <a href="index.html"><img src="${pageContext.request.contextPath}/resources/img/core-img/lotte_logo.png" alt=""></a>
            </div>
            <!-- Navbar Toggler -->
                ...
                <ul>
					...
					<c:choose>
						<c:when test="${sessionScope.memberVO==null}">
                			<li class="active"><button onclick="document.getElementById('id01').style.display='block'" style="width:auto;">Login</button></li>
         				</c:when>
         				<c:otherwise>
         					<%-- <a href="">${sessionScope.memberVO.name }님의 페이지</a> --%>
         					 <li class="active"><a href="${pageContext.request.contextPath}/mypage.do"><b>${sessionScope.memberVO.name }</b>님의 페이지</a></li>
         					  <li><a href="${pageContext.request.contextPath }/logHistory.do?memberId=${sessionScope.memberVO.memberId}"><b>로그 이력</b></a></li>
         					 <li><a href="${pageContext.request.contextPath }/logout.do?"><b>Log Out</b></a></li>
         				</c:otherwise>
         			</c:choose>
  ...
  <form class="modal-content animate" action="${pageContext.request.contextPath}/login.do" method="POST">
    <div class="imgcontainer">
      ...
      <img src="${pageContext.request.contextPath}/resources/img/bg-img/img_avatar2.png" alt="Avatar" class="avatar">
    </div>
    ...
    <div class="container" style="background-color:#f1f1f1">
      ...
      <span class="psw"><a href="${pageContext.request.contextPath}/registerPage.do"><h3>Sign up</h3></a></span>
    </div>
  </form>
</div>
